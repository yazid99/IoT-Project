        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthdate = table.Column<DateTime>(nullable: false, defaultValueSql: "'0001-01-01 00:00:00.000000'")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sirmotodevices", x => x.Id);
                    table.ForeignKey(
                        name: "UserIDFK",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
